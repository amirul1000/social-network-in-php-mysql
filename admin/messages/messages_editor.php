...
<b><?=ucwords(str_replace("_"," ","messages"))?></b><br />
<table cellspacing="3" cellpadding="3" border="0" align="center" width="98%" class="bdr">
 <tr>
  <td>  
     <a href="messages.php?cmd=list" class="nav3">List</a>
...
<select  name="to_users_id" id="to_users_id"   class="textbox">
	...
	?> 
						 ...
						 <td>
		           		 ...
		           		 <td>Read Status</td>
				   		 <td><?php
	$enummessages = getEnumFieldValues('messages','read_status');
?>
<select  name="read_status" id="read_status"   class="textbox">
<?php
   foreach($enummessages as $key=>$value)
   { 
?>
