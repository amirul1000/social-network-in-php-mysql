...
?>
<b><?=ucwords(str_replace("_"," ","messages"))?></b>
  <table cellspacing="3" cellpadding="3" border="0"  width="100%" class="bdr">
   ...
   <tr>
   <td> 
		<a href="messages.php?cmd=edit" class="nav3">Add a messages</a>
		<table cellspacing="1" cellpadding="3" border="0" width="100%" class="bodytext">
		 ...
		 ?>
			<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
			  ...
			  <td nowrap >
				  <a href="messages.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
				  <a href="messages.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a> 
			 </td>
