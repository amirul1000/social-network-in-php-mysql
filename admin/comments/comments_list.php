...
?>
<b><?=ucwords(str_replace("_"," ","comments"))?></b>
  <table cellspacing="3" cellpadding="3" border="0"  width="100%" class="bdr">
   ...
   <tr>
   <td> 
		<a href="comments.php?cmd=edit" class="nav3">Add a comment</a>
		<table cellspacing="1" cellpadding="3" border="0" width="100%" class="bodytext">
		 ...
		 ?>
			<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
			  ...
			  <td nowrap >
				  <a href="comments.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
				  <a href="comments.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a> 
			 </td>
