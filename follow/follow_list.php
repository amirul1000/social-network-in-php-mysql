...
?>
<b><?=ucwords(str_replace("_"," ","follow"))?></b>
  <table cellspacing="3" cellpadding="3" border="0"  width="100%" class="bdr">
			  ...
			  <form name="search_frm" id="search_frm" method="post">
				<table width="60%" border="0"  cellpadding="0" cellspacing="0" class="bodytext">
				  <TR>
					<TD  nowrap="nowrap">
					  <?php
						  $hash    =  getTableFieldsName("follow");
					...
					<td nowrap="nowrap" align="right">
					  <input type="hidden" name="cmd" id="cmd" value="search_follow" >
   ...
   <tr>
   <td> 
		<a href="follow.php?cmd=edit" class="nav3">Add a follow</a>
			...
			<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
			  ...
			  <td>
		                            <?php
										...
										$info2['table']    = users;	
										$info2['fields']   = array("password");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['follow_users_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['password'];	
					                ?>
							   </td>
			  ...
			  <td nowrap >
				  <a href="follow.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
				  <a href="follow.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a> 
			 </td>
