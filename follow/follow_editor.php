...
?>
<script language="javascript" src="follow.js"></script>
<script type="text/javascript" src="../../js/jquery.js"></script>
<script	src="../../js/main.js" type="text/javascript"></script>
<link rel="stylesheet" href="../../css/datepicker.css">
<b><?=ucwords(str_replace("_"," ","follow"))?></b><br />
<table cellspacing="3" cellpadding="3" border="0" align="center" width="98%" class="bdr">
 <tr>
  <td>  
     <a href="follow.php?cmd=list" class="nav3">List</a>
	 <form name="frm_follow" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
...
<select  name="owner_users_id" id="owner_users_id"   class="textbox">
	...
	$resusers  =  $db->select($info);
?>
<select  name="follow_users_id" id="follow_users_id"   class="textbox">
	<option value="">--Select--</option>
	<?php
	   foreach($resusers as $key=>$each)
	   { 
	?>
	  <option value="<?=$resusers[$key]['id']?>" <?php if($resusers[$key]['id']==$follow_users_id){ echo "selected"; }?>><?=$resusers[$key]['password']?></option>
	<?php
	 }
	?> 
</select></td>
