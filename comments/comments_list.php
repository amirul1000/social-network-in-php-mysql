  ...
  <div class="row">
    <div class="col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
      ...
      <h4 class="page-section-heading">Comments</h4>
			  ...
			  <form name="search_frm" id="search_frm" method="post">
				<table class="table v-middle"> 
				  <TR>
					<TD  nowrap="nowrap">
					  <?php
						  $hash    =  getTableFieldsName("comments");
					...
					<td nowrap="nowrap" align="right">
					  <input type="hidden" name="cmd" id="cmd" value="search_comments" >
   ...
   <tr>
   <td> 
		<a href="comments.php?cmd=edit" class="nav3">Add a comments</a>
		<table class="table v-middle"> 
			<tr bgcolor="#ABCAE0">
			  <td>Users</td>
			  <td>Contents</td>
		 ...
		 ?>
			<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
			  ...
			  <td nowrap >
                  <a href="comments.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a> 
                  <a href="comments.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
			 </td>
