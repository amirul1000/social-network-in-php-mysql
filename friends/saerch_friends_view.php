...
?>
<div class="page-section width-full marg-top66">
  <div class="row">
            ...
            <table class="table v-middle">
               <tr>
                        <td align="center" valign="top">
                            ...
                            <script type="text/javascript" src="../jquery-autocomplete-r3.2.2/jquery.autocomplete.js"></script>
                            <link rel="stylesheet" type="text/css" href="../jquery-autocomplete-r3.2.2/jquery.autocomplete.css">
                            <script type="text/javascript">
                                    $(function() {
                                                       
                                                $("#ac1").autocomplete('../friends/friends.php?cmd=friends_autocomplete');
                            ...
                            <form method="get" action="">
                                <input type="text" name="SearchText" id="ac1" value="<?=$_REQUEST['SearchText']?>"  class="ui-searchbar-keyword" placeholder="Search">
                                <input type="hidden" name="nav" value="nav">
                                <input type="hidden" name="cmd" value="search_by_keyword">
                        ...
                        <tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                          ...
                          <td nowrap >
                             <?php
							   ...
							   {
							  ?>
                               <a href="friends.php?cmd=unfriend&friend_users_id=<?=$arr[$i]['id']?>" class="btn btn-primary">Unfreind</a>
                             <?php
							   }
							   else if(get_freind_status($db,$arr[$i]['id'])=='pending')
							   {
							 ?>
                              <a href="friends.php?cmd=friend&friend_users_id=<?=$arr[$i]['id']?>" class="btn btn-primary">Resend Friend Request</a> 
                             <?php
							   }else 
							   {
							 ?>
                              <a href="friends.php?cmd=friend&friend_users_id=<?=$arr[$i]['id']?>" class="btn btn-primary">Send Friend Request</a> 
                             <?php
							   }
							 ?>
                         </td>
