<?php
	   ...
	   switch($cmd)
	   {
		  ...
		  case 'add': 
                ...
                $data['timezone_id']   = $_REQUEST['timezone_id'];
                $data['ticket_name']   = $_REQUEST['ticket_name'];
                $data['venue_name']   = $_REQUEST['venue_name'];
				$data['venue_city']   = $_REQUEST['venue_city'];
                ...
                if($_REQUEST['is_security_code']=='Yes')
				{  
					$data['security_code']   = $_REQUEST['security_code']; 
				}
				if($_REQUEST['is_security_code']=='No')
				{  
					$data['security_code']   = ''; 
				}
