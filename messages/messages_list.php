...
<div class="page-section">
  ...
  <table class="table v-middle">
			  ...
			  <form name="search_frm" id="search_frm" method="post">
				<table class="table v-middle">
				  <TR>
					<TD  nowrap="nowrap">
					  <?php
						  $hash    =  getTableFieldsName("messages");
						  $hash    = array_diff($hash,array("id,from_users_id,to_users_id"));
					  ?>
					  Search Key:
					...
					<td nowrap="nowrap" align="right">
					  <input type="hidden" name="cmd" id="cmd" value="search_messages" >
   ...
   <tr>
   <td> 
		<a href="messages.php?cmd=edit" class="btn btn-primary">Send  Message</a>
			...
			<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
			 ...
			 <!-- <td>
			  ...
			  <td> 
			         ...
			         <?=substr($arr[$i]['message'],0,10)?>
                    
                     <a href="messages.php?cmd=details&id=<?=$arr[$i]['id']?>" > More ...  </a>
			  ...
			  <td nowrap >
                      <!--<a href="messages.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a> |-->
                      <a href="messages.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
              </td>
