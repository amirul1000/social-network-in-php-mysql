...
<table cellspacing="3" cellpadding="3" border="0" align="center" width="98%" class="bdr table phototable1">
 <tr>
  <td>  
	 ...
	 <form name="frm_photos" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
		<table cellspacing="3" cellpadding="3" border="0" align="center" class="bodytext table phototable2" width="100%">  
            <tr>
                 <td>Photo Name</td>
                 <td>
