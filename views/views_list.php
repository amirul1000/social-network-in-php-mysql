...
?>
<b><?=ucwords(str_replace("_"," ","views"))?></b>
  <table cellspacing="3" cellpadding="3" border="0"  width="100%" class="bdr">
				...
				<table width="60%" border="0"  cellpadding="0" cellspacing="0" class="bodytext">
				  <TR>
					...
					<td nowrap="nowrap" align="right">
					  <input type="hidden" name="cmd" id="cmd" value="search_views" >
   ...
   <tr>
   <td> 
		<a href="views.php?cmd=edit" class="nav3">Add a views</a>
		<table cellspacing="1" cellpadding="3" border="0" width="100%" class="bodytext">
			<tr bgcolor="#ABCAE0">
				<td>Users Id</td>
			  <td>Viwers Users Id</td>
			  <td>Date Time</td>
			...
			<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
			  ...
			  <td>
					<?php
                        ...
                        $info2['where']    =  "1 AND id='".$arr[$i]['viwers_users_id']."' LIMIT 0,1";
                        $res2  =  $db->select($info2);
                        echo $res2[0]['first_name'].' '.$res2[0]['last_name'];	
                    ?>
               </td>
			  ...
			  <td nowrap >
				  <a href="views.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
				  <a href="views.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a> 
			 </td>
